	...
	<body>
		...
		<section id="add-block">
			...
			<form id="add-form" method="post">
				<input type="text" name="title" placeholder="Nouvel élément">
				<textarea name="definition" placeholder="Définition"></textarea>
				<input type="text" name="tags" placeholder="Tags (un-et-demi,deux,trois,etc)">
				<input type="text" name="link1" placeholder="Lien 1 (nom du lien [http://url.com])">
				<input type="text" name="link2" placeholder="Lien 2 (nom du lien [http://url.com])">
				<input type="text" name="link3" placeholder="Lien 3 (nom du lien [http://url.com])">
				<!-- BUTTON -->
